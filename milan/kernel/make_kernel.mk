...
KERNEL_CONFIG_PATH = $(PROJECT_ROOT)/device/board/huawei/milan/kernel/configs
export INSTALL_MOD_PATH := $(PROJECT_ROOT)/device/board/huawei/milan/modules
...
DTBS := qcom/msm8953-huawei-milan.dtb
